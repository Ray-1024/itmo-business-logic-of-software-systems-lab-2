    ...
    public SecurityFilterChain filterChain(HttpSecurity http, UserService userService, JwtTokenFilter jwtTokenFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        .requestMatchers(POST, "/api/videos:new").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(PUT, "/api/videos/*").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(GET, "/api/videos/*/status").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(POST, "/api/videos/*:publish").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(GET, "/api/videos").permitAll()
                        .requestMatchers(GET, "/api/videos/*").permitAll()
                        .requestMatchers(POST, "/api/comments").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(GET, "/api/comments").permitAll()
                        .requestMatchers(POST, "/api/reactions").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(GET, "/api/reactions").permitAll()
                        .requestMatchers(GET, "/api/reactions/my").hasRole(Role.RoleEnum.CLIENT.name())
                        .requestMatchers(PUT, "/api/sources/*").hasRole(Role.RoleEnum.CLIENT.name())
